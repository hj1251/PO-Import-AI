    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto" data-testid="dialog-settings">
        <DialogHeader>
          ...
          <DialogDescription>
            Bring your own API key. Calls go directly to your OpenAI or Anthropic account.
            Leave the provider on Demo to try the flow with no key.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="demo" data-testid="option-demo">Demo (no key, heuristic)</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                placeholder={draft.provider === "demo" ? "Not required for demo" : "sk-…"}
                value={draft.token}
